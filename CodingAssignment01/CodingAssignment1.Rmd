...
text2 <- paste("Symmetrical Unimodal distribution with the center at 30.2")
...
text3 <- paste("Right-Skewed distribution that is positively-skewed")
...
#### Spead of Age 
```{r, echo=FALSE}
boxplot(Insurance$Age, main="Figure 1.4 - Spread of Age", xlab="Spread of Age", ylab="Years", col="Blue")
```
