...
The code chunk below will remove the categorical variables (gender, smoker, cities) that we can ignore for this assignment from our analysis. 
...
### Center (Mean, Median)
The variables listed below were part of our analysis and included in the following Summary of Statistical Information.
...
3. **BMI**:  The data output for beneficiaries BMI is symmetrical as the Mean and Median are almost the same number. By looking at the mode will help validate this observation.  
  
4. **Children**: Most of the primary beneficiaries (34%) did not have dependents.
...
text1 <- paste("The above Histogram validates that the Primary Beneficiaries Age data is bimodal with two peaks in the graph. ")
