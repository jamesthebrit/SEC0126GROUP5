...
##A Postiive Intercept. Age Increases In A Linear Fashion. As BMI Increases So Does Charges. If Female Charges Increases. All Locations Help Decreases Charges Unless Default At Sanford.

##Of All SEEx2 Tests - Children Shows The Most Room For Error
```
...
Clients <- data.frame(
  ...
  lnBMI = c(log(22), log(30), log(25), log(35), log(27)),
  Female = c(1,0,0,1,1),
  Children = c(0,1,0,2,3),
  Smoker = c(0,0,1,0,0),
  WinterSprings = c(0,0,0,1,0),
  WinterPark = c(0,0,3,0,0),
  Oviedo = c(1,0,0,0,1)
  )
predict(model_LogChrgAgeSq, newdata = clients,interval = prediction)
```
